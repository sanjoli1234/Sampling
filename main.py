...
sampler1 = RandomUnderSampler(sampling_strategy='majority', random_state=4)
sampler2 = RandomOverSampler(sampling_strategy='minority', random_state=4)
